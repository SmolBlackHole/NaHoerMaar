...
class SessionRepository:
    ...
    __slots__ = ("_listening", "_session")

    def __init__(self, session: AsyncSession) -> None:
        self._session = session
        self._listening = ListeningRepository(session)
    ...
    async def load(self, session_id: ListeningSessionId) -> PlayerState | None:
        ...
        requests = await self._listening.requests(request_ids)
    ...
    async def save(self, state: PlayerState) -> None:
        ...
        await self._listening.add_requests(requests.values())
    ...
    async def undo(self, undo_id: UndoId) -> QueueUndo | None:
        ...
        requests = await self._listening.requests(
    ...
    async def save_undo(self, undo: QueueUndo) -> None:
        await self._listening.add_requests(
